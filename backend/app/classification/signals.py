...
CATEGORY_SIGNALS: dict[EmailCategory, list[SignalPattern]] = {
    ...
    EmailCategory.SPAM: [
        ...
        SignalPattern("mailbox has exceeded",                   weight=4.0),
        SignalPattern("exceeded its storage limit",             weight=4.0),
        SignalPattern("verify your account",                    weight=3.5),
        SignalPattern("account within 24 hours",                weight=3.5),
        SignalPattern("increase your shipping revenue",         weight=3.5),
